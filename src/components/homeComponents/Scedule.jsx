...
//         <div>
//           <Section no={'03'} section={'Scedule'}/>
//         </div>
//         <div className="flex flex-col justify-center items-center md:flex-row md:justify-between gap-20">
...
//               <span className="text-yellow-500">Game On:</span> <br /> Upcoming Match Schedule
//             </h2>
...
//             </p>
//             <div className=" rounded-3xl object-cover overflow-hidden h-[150px] xs:w-[90%] xs:h-[200px] md:h-[250px]">
//               <img 
...
//                   >
//                     <span className="text-2xl"><span className="text-sm text-gray-500">{item.id}.</span> {item.title}</span>
//                     <svg
...
//             <button
//                 className="inline-flex my-2 w-fit text-sm md:text-[16px] items-center gap-1 border-2 text-white border-black bg-black transform transition-transform duration-300 hover:border-yellow-600 hover:bg-yellow-600 hover:scale-110 px-2 py-1 rounded-full shadow-md ml-2 md:ml-4 align-middle"
//               >
//                 Join us
    ...
    <section className="mx-4 md:mx-8 py-8 overflow-x-hidden">
      ...
      >
        ...
        <div className="flex flex-col justify-between md:w-[50%]">
          ...
          <div className="flex justify-end">
            <button className="inline-flex my-2 w-fit text-sm md:text-[16px] items-center gap-1 border-2 text-white border-black bg-black transform transition-transform duration-300 hover:border-yellow-600 hover:bg-yellow-600 hover:scale-110 px-2 py-1 rounded-full shadow-md ml-2 md:ml-4 align-middle">
              Join us
              <span className="border-2 border-white bg-white rounded-full text-white">
                <GoArrowUpRight
                  size={15}
