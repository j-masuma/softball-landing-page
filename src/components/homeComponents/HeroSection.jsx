...
//                     <button className="inline-flex text-sm md:text-[16px] items-center gap-1 border-2 border-black bg-black hover:border-yellow-600 hover:bg-yellow-600 px-2 py-1 rounded-full shadow-md ml-2 md:ml-4 align-middle">
//                       Join us
