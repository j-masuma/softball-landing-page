...
//         {/* Left Section */}
//         <motion.div
//           className="flex flex-col justify-between md:w-1/5 p-2 mb-6 lg:mb-0"
...
//         {/* Right Section */}
//         <motion.div
//           className="flex flex-col xs:flex-row gap-4 xs:w-full md:gap-4 md:w-3/5"
//           initial={{ opacity: 0, x: 50 }}
//           whileInView={{ opacity: 1, x: 0 }}
//           transition={{ duration: 0.8 }}
//         >
...
//   return (
//     <div className="flex flex-col gap-6 sm:gap-8 border-2 p-4 sm:p-6 rounded-3xl bg-[#F1F1F1] border-[#F1F1F1] transition transform hover:scale-105 hover:shadow-xl duration-300 ease-in-out animate-bounceIn">
//       {/* Card Header */}
...
//           <img src={image} className="w-full h-full animate-fadeIn" alt="Profile" />
//         </div>
//       </div>

//       {/* Testimonial Content */}
//       <div className="text-lg sm:text-xl">
//         <div className="text-yellow-500 text-3xl sm:text-4xl animate-fadeIn">❝</div>
...
export const Testcards = ({ company, testimonial, name, position, image, address }) => {
  return (
    <div className="flex flex-col gap-6 sm:gap-8 border-2 p-4 sm:p-6 rounded-3xl bg-[#F1F1F1] border-[#F1F1F1] transition transform hover:scale-105 hover:shadow-xl duration-300 ease-in-out max-w-[300px]">
      {/* Card Header */}
      <div className="flex justify-between items-center">
        <div className="flex gap-2 items-center border-2 p-2 rounded-3xl">
          <PiDropboxLogoLight size={20} />
